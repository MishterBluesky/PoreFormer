...
current_value=$start_value
    ...
    # Step 9
    gmx grompp -f em2.mdp -o emx_$name -c 7_$name.gro -p topol.top -maxwarn 1000
    ...
    # Step 12
    gmx grompp -f em2.mdp -o 9_$name -c 8_$name.gro -maxwarn 1000

    # Step 13
    gmx_d mdrun -deffnm 9_$name -v

    # Step 14
    gmx grompp -f em2.mdp -o neutral_$name.tpr -p topol.top -c 9_$name.gro -maxwarn 1000

    # Step 15
    echo 13 | gmx genion -s neutral_$name.tpr -o 10_$name.pdb -p topol.top -neutral -conc $3

    # Step 16
    gmx grompp -f em2.mdp -o 11_$name.tpr -p topol.top -c 10_$name.pdb -maxwarn 1000

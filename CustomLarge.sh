...
current_value=$start_value
    ...
    # Step 3
    ./PLM -TSfile modified.tsi -Mashno 5 -bilayerThickness 4.3 -rescalefactor 2 2 2 -o 4_Lipidx_$current_value
...
ag = u.select_atoms("byres ((prop abs y < 1305) and (prop abs y > 615) and (prop abs z < 1305) and (prop abs z > 615)) ")
ag.write('6_$name.gro')
END


    # Step 7
    gmx editconf -f 6_$name.gro -o 7_Lipidx_$name.gro -box 70.5 70.5 80 -rotate 0 90 0

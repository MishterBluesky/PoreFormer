...
current_value=$start_value
    ...
    # Step 15
    echo 5 | gmx genion -s neutral_$name.tpr -o 10_Lipidx_$name.pdb -p topol.top -neutral
    ...
    # Step 19
    gmx grompp -f mdp_files/cgmdprepx.mdp -o 11b_Lipid20_$name.tpr -c 11_Lipid20x_$name.gro -p topol.top -maxwarn 1000
    ...
    gmx grompp -f mdp_files/cgmd-500ns-2024tpr.mdp -o $name/12_md20_$name -c 11b_Lipid20_$name.gro -p topol.top -maxwarn 1000
